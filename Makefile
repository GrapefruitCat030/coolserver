...
test-server: test-util.cpp Epoll.cpp Socket.cpp Inetaddress.cpp test-server.cpp
	g++ $(CFLAG) test-util.cpp Epoll.cpp Socket.cpp Inetaddress.cpp test-server.cpp -o test-server
